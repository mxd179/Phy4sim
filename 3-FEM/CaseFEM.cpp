...
namespace VCX::Labs::FEM {
    ...
    void CaseFEM::OnSetupPropsUI() {
        if (ImGui::CollapsingHeader("Simulation / Control", ImGuiTreeNodeFlags_DefaultOpen)) {
            ...
            ImGui::Separator();
            ImGui::SliderFloat("Young (Pa)", &_young, 100.0f, 200000.0f, "%.1f");
        ...
        if (ImGui::CollapsingHeader("Interaction (RMB Drag)", ImGuiTreeNodeFlags_DefaultOpen)) {
            ...
            ImGui::SliderFloat("dragK", &_dragK, 0.0f, 3000.0f, "%.1f");
            ImGui::SliderFloat("dragDamp", &_dragDamp, 0.0f, 300.0f, "%.1f");
            ImGui::SliderFloat("maxDragForce", &_maxDragForce, 100.0f, 30000.0f, "%.1f");
            ImGui::Text("Use Right Mouse Button (RMB) to drag the selected vertex.");
        }
